...
- **When hardening code for security by design** → Use skill: `tortoise-harden`
- **When auditing for deep/subtle vulnerabilities** → Use skill: `tortoise-harden`
...
| `tortoise-harden` | Security hardening, defense in depth, secure by design |
