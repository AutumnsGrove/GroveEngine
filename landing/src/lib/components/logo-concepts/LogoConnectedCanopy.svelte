<!--
  Grove Logo Concept 2: The Connected Canopy
...
>
	...
	/>
	<!-- Center canopy (overlaps both, creating depth) -->
	<ellipse
		cx="16" cy="12"
		rx="5" ry="7"
		fill={color}
	/>
	<!-- Small trunk suggestion at bottom -->
	<rect x="14" y="22" width="4" height="6" rx="1" fill={trunk} opacity="0.7" />
</svg>
