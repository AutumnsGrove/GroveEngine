					...
					<div class="supporter-circle mb-10" id="queer-quest">
						...
						<div class="supporter-card featured">
							...
							<p class="supporter-note">
								My old dungeon master from college who ran Queer Quest—D&D one-shots centered around queer stories, hosted at the LGBTQIA+ center. When I told him about Grove, he sent an incredible message to his communities, championing the vision and encouraging support. That kind of belief in what we're building here means everything.
							</p>
						</div>
					</div>
