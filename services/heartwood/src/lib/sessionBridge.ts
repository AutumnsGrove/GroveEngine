...
import { getDeviceId, parseDeviceName, getClientIP, getUserAgent } from "./session.js";
 ...
 */
export function getRequestContext(request: Request): PendingRequestContext | undefined {
 ...
 */
export function setSessionBridgeResult(request: Request, result: SessionBridgeResult): void {
 ...
 */
export function getSessionBridgeResult(request: Request): SessionBridgeResult | undefined {
