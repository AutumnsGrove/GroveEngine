...
Not a spreadsheet with dates. Not a Notion page with checkboxes. An actual journey. Seasons changing as the grove grows.

**→ [grove.place/roadmap](https://grove.place/roadmap)**

You'll start in First Frost (the foundations). Right now we're in Thaw. The doors are opening. Scroll down to watch the grove grow through spring, summer, autumn... and eventually, a dream that glows in the dark.
...
- No em dashes (Autumn's preference)
- Invites curiosity without over-explaining
- "A dream that glows in the dark" references Midnight Bloom without spoiling it
- Trust the page to do the heavy lifting
...
*This email is an invitation to wander.*
