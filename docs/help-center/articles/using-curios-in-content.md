...
Configure each curio in **Admin → Curios** first, then embed it wherever you'd like.
...
- **Polls need an ID.** Unlike other curios, polls use `::poll[your-poll-id]::` because you can have multiple polls. Find the ID on the poll's admin page.
