...
**Wisp** (writing assistant) analyzes your drafts for grammar, tone, and readability. Your post content goes to an inference provider, gets analyzed, and disappears. Only the suggestions come back. Wisp also includes **Fireside mode**—a conversational feature where you talk through your ideas and Wisp organizes your own words into a draft. The conversation is processed, the draft is generated, and everything disappears. Only the words you choose to keep remain.
...
**For text processing (Wisp, Fireside, Thorn, Forage):** Fireworks AI, Cerebras, and Groq. Each has explicit ZDR policies.
