...
Follows the gw pattern: Click group with context object carrying config + output.
...
from glimpse.output.console import GlimpseOutput
...
@click.pass_context
def main(ctx: click.Context, agent: bool, output_json: bool, verbose: bool) -> None:
    """Glimpse — A quick peek through the trees.

    Capture screenshots of Grove sites with theme control,
    element targeting, and agent-friendly output modes.
    """
