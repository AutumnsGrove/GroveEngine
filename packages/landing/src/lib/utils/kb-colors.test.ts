...
import { kbCategoryColors, categoryLabels, type CategoryColors } from './kb-colors';
...
describe('kb-colors.ts', () => {
  ...
  describe('consistency checks', () => {
    ...
    it('should share colors between categories with same season', () => {
      ...
      expect(kbCategoryColors.help.iconBg).toBe(kbCategoryColors.marketing.iconBg);
      ...
      expect(kbCategoryColors.specs.iconBg).toBe(kbCategoryColors.philosophy.iconBg);
      expect(kbCategoryColors.specs.text).toBe(kbCategoryColors.philosophy.text);
    });
  });
});
