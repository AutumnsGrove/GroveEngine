<script lang="ts">
  ...
  import { GlassCard, Button, Input, GroveTerm } from '@autumnsgrove/groveengine/ui';
  import { Search, Users, Leaf, TreePine } from '@autumnsgrove/groveengine/ui/icons';
  import {
...
<main class="min-h-screen">
  <div class="max-w-5xl mx-auto px-4 sm:px-6 py-12">
    ...
    <header class="text-center mb-16">
      <div class="text-accent-muted mb-4">
        <TreePine size={48} />
      </div>
      <h1 class="text-4xl md:text-5xl font-serif text-foreground mb-3">
        The <GroveTerm term="canopy" />
      </h1>
      <p class="text-lg text-accent-muted font-sans font-semibold mb-2">
        See who's growing here
      </p>
      <p class="text-foreground-muted font-sans max-w-md mx-auto">
