...
<section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
	<!-- Feedback Card -->
	<a href="/admin/feedback" class="block">
	...
	<!-- Subscribers Card -->
	<a href="/admin/subscribers" class="block">
		<GlassCard hoverable class="p-6 h-full">
			<div class="flex items-start gap-4">
				<div class="w-12 h-12 bg-grove-100 dark:bg-grove-900/30 rounded-lg flex items-center justify-center flex-shrink-0">
	...
	{#if data.isWayfinder}
		<a href="/admin/porch" class="block">
			<GlassCard hoverable class="p-6 h-full">
				<div class="flex items-start gap-4">
					<div class="w-12 h-12 bg-grove-100 dark:bg-grove-900/30 rounded-lg flex items-center justify-center flex-shrink-0">
		...
		<a href="/admin/greenhouse" class="block">
			<GlassCard hoverable class="p-6 h-full">
				<div class="flex items-start gap-4">
