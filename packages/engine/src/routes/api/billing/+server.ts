 ...
 * Returns a 429 response if rate limited, undefined otherwise.
 */
async function checkBillingRateLimitOrError(
...
export const POST: RequestHandler = async ({
  ...
  try {
    ...
    const rateLimitResponse = await checkBillingRateLimitOrError(
