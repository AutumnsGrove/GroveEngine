...
<div class="ambient-page">
  <header class="page-header">
    ...
    <p class="subtitle">
      ...
      Always requires a click — never autoplay.
    </p>
  </header>
    ...
    <form method="POST" action="?/save" use:enhance>
      <div class="form-grid">
        ...
        <div class="form-field full-width">
          <label for="customUrl">Custom Audio URL <span class="optional">(optional, Oak+)</span></label>
          <input
            type="url"
            id="customUrl"
            name="customUrl"
...
<style>
  .ambient-page { max-width: 800px; margin: 0 auto; }
