 ...
 *
 * @param {ProviderConfig} provider - Provider config
...
/**
 * @typedef {Object} InferenceSecrets
 * @property {string} [FIREWORKS_API_KEY]
 ...
 * @param {InferenceSecrets} secrets - Secrets object
 * @returns {string|null}
 */
