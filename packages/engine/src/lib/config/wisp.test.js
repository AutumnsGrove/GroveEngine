...
describe("getModelId", () => {
  ...
  it("should return null for null/undefined inputs", () => {
    // @ts-expect-error - Testing edge case with null input
...
describe("getProvider", () => {
  ...
  it("should return null for null/undefined", () => {
    ...
    // @ts-expect-error - Testing edge case with undefined input
...
describe("getMaxTokens", () => {
  ...
  describe("Default Behavior", () => {
    ...
    it("should return 1024 for unknown action", () => {
      // @ts-expect-error - Testing edge case with invalid action type
