...
{#if !job}
	<GlassCard variant="muted" class="p-12 text-center">
		...
		<GlassButton variant="accent" href="/arbor/history" class="mt-4">
			Back to History
		</GlassButton>
	</GlassCard>
{:else}
		...
		<div class="flex items-start justify-between">
			<div>
				<div class="flex items-center gap-3 mb-2">
					<a href="/arbor/history" class="text-foreground-subtle hover:text-foreground transition-colors" aria-label="Back to history">
