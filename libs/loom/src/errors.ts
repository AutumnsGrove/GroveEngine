...
export const LOOM_ERRORS = {
	...
	INIT_FAILED: {
		...
		adminMessage: "DO schema initialization failed during blockConcurrencyWhile.",
	},
	...
	EMIT_NO_QUEUE: {
		...
		category: "bug" as const,
		userMessage: "Service temporarily unavailable.",
		adminMessage: "emit() called but no queue binding found in env. Check wrangler.toml.",
	},
	...
	WORKFLOW_NO_BINDING: {
		...
		category: "bug" as const,
		userMessage: "Service temporarily unavailable.",
		adminMessage: "workflow() called but no workflow binding found in env. Check wrangler.toml.",
	},
