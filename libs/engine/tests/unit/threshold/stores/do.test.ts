...
import { ThresholdDOStore } from "$lib/platform/threshold/stores/do.js";
import { ThresholdKVStore } from "$lib/platform/threshold/stores/kv.js";
...
function createMockDONamespace(handler?: (...args: any[]) => Promise<Response>) {
