...
export const ATMOSPHERE_MANIFOLD: readonly AtmosphereEntry[] = [
...

	{
		keyword: "midnight",
		description:
			"Deep plum shadows, monospace precision, crickets in the dark. A library after hours.",
...

	{
		keyword: "dreamy",
		description:
			"Violet purple, handwritten script, ocean waves, soft glow. Half asleep, half creating.",
