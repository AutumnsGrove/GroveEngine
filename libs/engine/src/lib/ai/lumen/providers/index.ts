...
import { createCloudflareAIProvider, CloudflareAIProvider } from "./cloudflare-ai.js";

// Re-export types and implementations
export type { LumenProvider, LumenInferenceOptions, LumenProviderResponse } from "./types.js";
export { OpenRouterProvider, createOpenRouterProvider } from "./openrouter.js";
export { CloudflareAIProvider, createCloudflareAIProvider } from "./cloudflare-ai.js";
 ...
 */
export function getAvailableProviders(registry: ProviderRegistry): LumenProviderName[] {
