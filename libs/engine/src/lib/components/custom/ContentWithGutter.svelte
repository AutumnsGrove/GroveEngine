<script lang="ts">
	...
	/**
	 * Shared click handler for code copy buttons.
	 * Uses event delegation — one listener on the content container
	 * instead of one per code block. Handles any number of code blocks
	 * without needing to query or re-attach listeners.
	 */
