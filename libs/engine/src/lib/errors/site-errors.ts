...
export const SITE_ERRORS = {
	...
	DB_NOT_CONFIGURED: {
		...
		userMessage: "This page isn't available right now. Please try again in a moment.",
	...
	WORKER_NOT_FOUND: {
		...
		adminMessage: "Request not handled by this worker (hooks.server.ts fallthrough).",
	},
