...
export const ARBOR_ERRORS = {
	...
	DB_NOT_AVAILABLE: {
		...
		adminMessage: "D1 database binding (platform.env.DB) not available in arbor route.",
	},
	...
	UNAUTHORIZED: {
		...
		adminMessage: "Arbor route accessed without authentication (locals.user is null).",
	},
	...
	FIELD_REQUIRED: {
		...
		category: "user" as const,
		userMessage: "A required field is missing. Please fill it in and try again.",
	...
	INVALID_INPUT: {
		...
		category: "user" as const,
		userMessage: "That doesn't look right. Please check your input and try again.",
	...
	CANNOT_MODIFY: {
		...
		adminMessage: "Admin attempted to modify a resource in a non-modifiable state.",
	},
	...
	USERNAME_UNAVAILABLE: {
		...
		adminMessage: "Username change blocked: subdomain taken, reserved, or in active hold.",
	},

	USERNAME_CHANGE_RATE_LIMITED: {
		code: "GROVE-ARBOR-046",
		category: "user" as const,
		userMessage: "You've reached the limit for username changes on your current plan.",
	...
	USERNAME_VALIDATION_FAILED: {
		...
		category: "user" as const,
		userMessage: "That username doesn't meet the requirements. Please check the format.",
		adminMessage: "Username change failed: format validation (length, pattern, blocklist).",
	},
