...
import { thresholdHeaders } from "../../platform/threshold/adapters/sveltekit.js";
import type { ThresholdResult } from "../../platform/threshold/types.js";

export { getClientIP } from "../../platform/threshold/adapters/worker.js";
export { thresholdHeaders as rateLimitHeaders } from "../../platform/threshold/adapters/sveltekit.js";
...
export async function checkRateLimit(options: {
	...
	try {
		...
		const data = await options.kv.get<{ count: number; resetAt: number }>(fullKey, "json");
