...
export const GRAFT_REGISTRY = new Map<GraftId, GraftRegistryEntry>([
	[
		"pricing",
		{
			id: "pricing",
			name: "Pricing Graft",
			description: "Reusable pricing table, cards, and checkout components for any Grove product",
	...
	[
		"upgrades",
		{
			id: "upgrades",
			name: "UpgradesGraft",
			description: "Cultivation, garden management, and growth tracking for Grove products",
 ...
 */
export function getGraftEntry(graftId: GraftId): GraftRegistryEntry | undefined {
 ...
 */
export function getGraftsByStatus(status: GraftRegistryEntry["status"]): GraftRegistryEntry[] {
