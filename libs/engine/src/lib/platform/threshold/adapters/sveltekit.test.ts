...
import { thresholdCheck, thresholdCheckWithResult, thresholdHeaders } from "./sveltekit.js";
...
describe("SvelteKit adapter", () => {
	...
	describe("thresholdHeaders()", () => {
		it("generates correct headers for allowed request", () => {
			const headers = thresholdHeaders({ allowed: true, remaining: 8, resetAt: 1739620800 }, 10);
