...
export const THRESHOLD_ERRORS = {
	...
	RATE_LIMITED: {
		...
		userMessage: "You're moving faster than we can keep up! Take a moment and try again soon.",
	...
	RATE_LIMITED_AUTH: {
		...
		adminMessage: "Rate limit exceeded for authentication endpoint (fail-closed).",
	},

	RATE_LIMITED_UPLOAD: {
		code: "GROVE-THRESHOLD-022",
		category: "user" as const,
		userMessage: "You've uploaded a lot recently. Please wait a bit before uploading more.",
	...
	RATE_LIMITED_AI: {
		...
		category: "user" as const,
		userMessage: "You've reached your AI usage limit for today. It resets at midnight UTC.",
	...
	RATE_LIMITED_TENANT: {
		...
		category: "user" as const,
		userMessage: "Your site is seeing a lot of traffic! Some requests may be slower than usual.",
	...
	SERVICE_UNAVAILABLE: {
		...
		category: "bug" as const,
		userMessage: "Unable to process your request right now. Please try again in a moment.",
		adminMessage: "Rate limit check failed with failMode=closed, returning 503.",
	},
	...
	ABUSE_WARNING: {
		...
		adminMessage: "Abuse warning issued — user has 1-4 rate limit violations within decay window.",
	},
	...
	ABUSE_BANNED: {
		...
		adminMessage: "User banned for 24 hours — 5+ rate limit violations within decay window.",
	},
	...
	UNKNOWN_ENDPOINT: {
		...
		adminMessage: "Endpoint not found in ENDPOINT_MAP — using default rate limits.",
	},
	...
	INVALID_TIER: {
		...
		category: "bug" as const,
		userMessage: "Service temporarily unavailable.",
		adminMessage: "Invalid subscription tier passed to checkTier or checkTenant.",
	},
