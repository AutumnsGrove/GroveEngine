<script lang="ts">
	...
	let { graft, onToggle, loading = false, class: className = "" }: GraftToggleRowProps = $props();
	...
	<div class="graft-content">
		...
		<div class="graft-info">
			<div class="graft-header">
				...
				<span class="maturity-badge maturity-{graft.maturity}" title="{graft.maturity} feature"
					>{graft.maturity}</span
				>
