...
export async function evaluateRule(
	...
	switch (rule.ruleType as RuleType) {
		...
		case "percentage":
			return evaluatePercentageRule(rule.ruleValue as PercentageRuleCondition, context, flagId);
		case "user":
		...
		case "tenant_override":
			return evaluateTenantOverrideRule(rule.ruleValue as TenantOverrideCondition, context);
		case "always":
			return true;
		default:
 ...
 */
function evaluateTenantRule(condition: TenantRuleCondition, context: EvaluationContext): boolean {
 ...
 */
function evaluateTierRule(condition: TierRuleCondition, context: EvaluationContext): boolean {
 ...
 */
function evaluateUserRule(condition: UserRuleCondition, context: EvaluationContext): boolean {
