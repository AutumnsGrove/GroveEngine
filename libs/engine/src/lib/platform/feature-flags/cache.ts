 ...
 */
export function cachedToResult<T>(cached: CachedFlagValue<T>): EvaluationResult<T> {
	return {
		value: cached.value,
 ...
 */
export async function invalidateFlag(flagId: string, env: FeatureFlagsEnv): Promise<number> {
