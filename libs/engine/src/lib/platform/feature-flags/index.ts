...
// Flags API (Engine-first loading) — new names
export { getEnabledFlags, isFlagEnabled, type FlagsRecord, type KnownFlagId } from "./flags.js";

// Flags API — backward compat aliases (deprecated)
export { getEnabledGrafts, isGraftEnabled, type GraftsRecord, type KnownGraftId } from "./flags.js";
...
// Tenant Flag Overrides (Self-serve controls)
export {
