...
describe("PKCE Utilities", () => {
	...
	describe("generateRandomString", () => {
		...
		it("has sufficient entropy (statistical test)", () => {
			...
			const strings = Array.from({ length: 100 }, () => generateRandomString(64));
	...
	describe("generateCodeChallenge", () => {
		it("generates a base64url-encoded challenge", async () => {
			const verifier = "test_verifier_with_sufficient_length_for_testing_purposes";
		...
		it("produces different output for different input", async () => {
			const challenge1 = await generateCodeChallenge("verifier_one_for_testing");
			const challenge2 = await generateCodeChallenge("verifier_two_for_testing");
