 ...
 * ```typescript
 * import { buildLoginUrl } from '$lib/auth/login/config.js';
 * throw redirect(302, buildLoginUrl(`${url.origin}/auth/callback?returnTo=/arbor`));
 * ```
 */

// Types
export type { CallbackHandlerConfig, PKCEValues, AuthCookieState } from "../types.js";
...
// Origin utilities
export { getRealOrigin, isProduction, isGrovePlatform, getCookieDomain } from "./origin.js";
