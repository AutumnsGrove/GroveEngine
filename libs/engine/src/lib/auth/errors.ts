...
export const AUTH_ERRORS = {
	...
	REDIRECT_URI_MISMATCH: {
		...
		category: "admin" as const,
		userMessage: "Sign-in failed due to a configuration issue. Contact support.",
		adminMessage: "The redirect_uri does not match any registered URI for this client.",
	},
	...
	NO_SESSION: {
		...
		adminMessage: "No session cookie was set after OAuth callback. May indicate cookie blocking.",
	},
	...
	TOKEN_EXCHANGE_FAILED: {
		...
		adminMessage: "Failed to exchange authorization code for tokens. Check client credentials.",
	},

	LEGACY_SESSION_EXPIRED: {
		code: "HW-AUTH-024",
		category: "user" as const,
		userMessage: "Your old session format has expired. Please sign in with a fresh login.",
		adminMessage: "Legacy session cookie found but migration deadline has passed.",
	},
	...
	UNREGISTERED_CLIENT: {
		...
		category: "admin" as const,
		userMessage: "Sign-in failed due to a configuration issue. Contact support.",
		adminMessage: "Client ID is not registered with GroveAuth or has been revoked.",
	},
	...
	ORIGIN_NOT_ALLOWED: {
		...
		category: "admin" as const,
		userMessage: "Sign-in failed due to a configuration issue. Contact support.",
		adminMessage: "The request origin is not in the allowed origins list for this client.",
	},
 ...
 */
export function buildErrorParams(error: AuthErrorDef, isAdminFlow = false): string {
