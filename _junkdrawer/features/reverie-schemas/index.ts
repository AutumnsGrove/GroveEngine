...
export { ATMOSPHERE_MANIFOLD, findAtmosphere, ALL_ATMOSPHERE_KEYWORDS } from "./atmosphere";
...
export const DOMAIN_CATALOG: readonly CatalogEntry[] = [
	...
	},
	{
		...
		fieldCount: 6,
		phase: 4,
		file: "identity/activitystatus.ts",
	},
...
export const IMPLEMENTED_FIELD_COUNT = DOMAIN_CATALOG.filter(
